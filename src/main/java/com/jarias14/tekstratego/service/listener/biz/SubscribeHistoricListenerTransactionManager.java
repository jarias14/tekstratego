...
public class SubscribeHistoricListenerTransactionManager implements TransactionManager<ListenerRequest, ListenerResponse> {
    ...
    public ListenerResponse process(ListenerRequest listenerRequest) {
        ...
        Set<DataPointCollection> historicalMarketData = marketDataDAO.getPriceBars(listenerRequest.getSymbol(), listenerRequest.getStartDate(), listenerRequest.getEndDate());
    ...
    public void setHistoricDataDao(DataAccessObject<Boolean, RawDataRequest> historicDataDao) {
