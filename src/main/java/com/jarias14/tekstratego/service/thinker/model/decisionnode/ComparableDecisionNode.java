 ...
 */
public class ComparableDecisionNode<TYPE  extends Comparable> implements DecisionNode<TYPE> {

    private String id;
    private DataPointDetails dataPointKey;
    private Map<ComparableRange, String> descendantNodes;

    public ComparableDecisionNode(String id, DataPointDetails indicator, Map<ComparableRange, String> decisionNodes) {
        this.id = id;
